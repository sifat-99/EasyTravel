...
import dream_team.easy_travel.mainApp.PaymentModal;
...
public class RestaurantsUploadForAdmin extends JPanel {
    private Easy_Travel app;
    private JPanel placesPanel;
    private JTextField searchField;
    private JButton openModalButton;

    public RestaurantsUploadForAdmin(Easy_Travel app) {
